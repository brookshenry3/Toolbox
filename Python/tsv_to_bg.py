...
'''
A script to convert methylation frequency tsv files to bedGraph format for downstream use (i.e. in Methrix)

Run using : python3 tsv_to_bg.py -f input.tsv -o output.bedGraph
'''
