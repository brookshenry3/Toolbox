...
#Will return the following files:
#File in BED format for use in plotting in IGV, analysis, etc.
#File in TSV file containing bin information, relevant information to analysis
#Image in PNG format of the meth plotted
...
#Telomere bed file
TELOMERES = 'path/to/hg38_telomere_annots.bed'
#CytoBand txt file containing the centromere coords
CENTROMERES <- "path/to/hg38_cytoband.txt"
...
OUTPUT.LOC = "path/to/output/location"
